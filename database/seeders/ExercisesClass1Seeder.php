...
class ExercisesClass1Seeder extends Seeder
{
    public function run(): void
    {
        $now = Carbon::now();
        $exercises = json_decode(file_get_contents(database_path("data/exercises_class1.json")), true);
        $count = 0;
        ...
        $this->command->info("Exercices Class 1 seedes: {$count}");
    }
}