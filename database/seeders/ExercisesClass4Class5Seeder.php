...
class ExercisesClass4Class5Seeder extends Seeder
{
    public function run(): void
    {
        ...
        $files = [
            database_path("data/exercises_class4.json"),
            database_path("data/exercises_class5.json"),
        ];
        ...
        $this->command->info("Exercices Class 4 + Class 5 seedes: {$count}");
    }
}